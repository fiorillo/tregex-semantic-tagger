...
public class IOUtils {
  ...
  public static File writeObjectToFile(Serializable o, String filename) throws IOException {
     ...
     * @return File containing the object
     */
  public static File writeObjectToFile(Serializable o, File file) throws IOException {
  ...
  public static BufferedReader readerFromStringName(String textFileOrUrl, String encoding) throws IOException {
    InputStream is;
    if (textFileOrUrl.startsWith("http://")) {
      URL u = new URL(textFileOrUrl);
      URLConnection uc = u.openConnection();
