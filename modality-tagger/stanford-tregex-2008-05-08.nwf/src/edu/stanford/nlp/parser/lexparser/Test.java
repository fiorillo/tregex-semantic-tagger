...
public class Test {
  ...
  /**
   * Only valid with force tags - strips away functionals when forcing the tags, meaning
   * tags have to start appropriately but the parser will assign the functional part
   */
