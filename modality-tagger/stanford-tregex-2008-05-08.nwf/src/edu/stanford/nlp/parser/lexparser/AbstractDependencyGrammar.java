...
public abstract class AbstractDependencyGrammar implements DependencyGrammar {
  ...
  protected IntDependency intern(IntTaggedWord headTW, IntTaggedWord argTW, boolean leftHeaded, short dist) {
    ...
    internTempDependency.head = (IntTaggedWord) edu.stanford.nlp.util.Interner.globalIntern(headTW);
    internTempDependency.arg = (IntTaggedWord) edu.stanford.nlp.util.Interner.globalIntern(argTW);
