...
public class BasicDocument extends ArrayList implements Document {
  ...
  public Document blankDocument() {
    ...
    try {
      bd = (BasicDocument) getClass().newInstance();
    } catch (Exception e) {
  ...
  public static void main(String[] args) {
    try {
      printState(new BasicDocument().init("this is the text", "this is the title [String]", true));
      printState(new BasicDocument().init(new StringReader("this is the text"), "this is the title [Reader]", true));
