...
public class IntCounter<E> extends AbstractCounter<E> implements Serializable {
  ...
  public void defaultReturnValue(double rv) { throw new UnsupportedOperationException(); }

  public double defaultReturnValue() { return 0.0; }
  ...
  public double averageCount() {
    return totalCount() / (double) map.size();
  }
  ...
  public double remove(E key) {
    ...
    return map.remove(key).doubleValue();
  }
  ...
  public String toString(NumberFormat nf, String preAppend, String postAppend, String keyValSeparator, String itemSeparator) {
    ...
    sb.append(preAppend);
    List list = new ArrayList<E>(map.keySet());
    try {
  ...
  public Collection<Double> values() {
    return new AbstractCollection<Double>() {
      ...
      public boolean contains(double key) {
        return map.values().contains(new MutableInteger((int)key));
      }
