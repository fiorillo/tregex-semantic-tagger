 ...
 */
public class Distribution<E> implements Serializable, Sampler<E>, ProbabilityDistribution<E> {
   ...
   */
  public static <E> Distribution<E> getDistributionFromPartiallySpecifiedCounter(ClassicCounter<E> c, int numKeys){
    Distribution<E> d;
