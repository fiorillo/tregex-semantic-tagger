...
public class SemanticHeadFinder extends ModCollinsHeadFinder {
  ...
  public SemanticHeadFinder(TreebankLanguagePack tlp, boolean cop) {
    ...
    verbalAuxiliaries.addAll(Arrays.asList(new String[]{"will", "wo", "shall", "may", "might", "should", "would", "can", "could", "ca", "must", "has", "have", "had", "having", "be", "being", "been", "get", "gets", "getting", "got", "gotten", "do", "does", "did", "to", "'ve", "'d", "'ll"}));
  ...
  private void ruleChanges() {
    ...
    nonTerminalInfo.put("WHNP", new String[][]{{"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "POS", "JJR"}, {"left", "NP"}, {"rightdis", "$", "ADJP", "PRN"}, {"right", "CD"}, {"rightdis", "JJ", "JJS", "RB", "QP"}, {"left", "WHNP", "WHPP", "WHADJP", "WP$", "WP", "WDT"}});
    //WHADJP
    ...
    nonTerminalInfo.put("SQ", new String[][]{{"left", "VP", "SQ", "VB", "VBZ", "VBD", "VBP", "MD"}});
    ...
    nonTerminalInfo.put("FRAG", new String[][]{{"left"}});
   ...
   *
   */
  static private boolean isWHQ(Tree t, Tree parent) {
    if (t == null) {
      return false;
    }
    boolean toReturn = false;
  ...
  private boolean hasVerbalAuxiliary(Tree[] kids, HashSet<String> verbalSet) {
    ...
    for (int i = 0; i < kids.length; i++) {
      ...
      if (DEBUG) {
        System.err.println("Checking " + kids[i].value() + " head is " + word + "/" + tag);
      }
