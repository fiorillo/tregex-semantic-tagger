...
public class WordLemmaTag implements Label, Comparable<WordLemmaTag>, HasWord, HasTag {
  ...
  public boolean equals(Object obj) {
    return (obj instanceof WordLemmaTag) && (word().equals(((WordLemmaTag) obj).word())) && (lemma().equals(((WordLemmaTag) obj).lemma())) && (tag().equals(((WordLemmaTag) obj).tag()));
  }
   ...
   *
   * @param divider The String between words, tags (and lemmas)
   */
