...
public class CNFTransformers {
  ...
  public static void main(String[] args) {
    ...
    String path = args[0];
    List trees = TreebankAnnotator.getTrees(path, 200, 219, 0, 10);
    List annotatedTrees = new TreebankAnnotator(new Options(), path).annotateTrees(trees);
    for (Iterator annotatedTreesI = annotatedTrees.iterator(); annotatedTreesI.hasNext();) {
      Tree tree = (Tree) annotatedTreesI.next();
