...
Version 2.0.2 2012-03-09
    Efficiency improvements
Version 2.0.1 2011-12-16
    Fix bug in matchesAt, fix bug in category function, add macros
Version 2.0 2011-09-14
    Efficiency improvements, include semgrex.
Version 1.4.4 2011-05-15
    Rebuilt to be compatible with everything.
Version 1.4.3 2011-05-15
    Rebuilt to be compatible with everything.
Version 1.4.2 2011-04-17
    Rebuilt to be compatible with tagger, parser, and corenlp.
Version 1.4.1 2010-11-18
    Small fixes and improvements (improved help screens, multipattern Tsurgeon
    scripts with comments introduced by % supported, unclosed regex no
    longer crashes GUI, support character encodings in script files, fix
    bug in tregex matching immediate domination path, TregexGUI now
    shows filename and line number of each match in matches panel)
...
Version 1.1  2008-05-06
    Several bug fixes; addition of browse trees function, improved
    copy/paste and drag and drop support; misc. feature additions
